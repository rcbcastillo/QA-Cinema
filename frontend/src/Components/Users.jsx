...
const Users = (props) => {
  ...
  function compare(array, variable, variable2) {
    return (
      array.find(
        (item) => item.email === variable && item.password === pass
      ) !== undefined
    );
  }
                    ...
                    <TimelineItem>
                      ...
                      <TimelineBody className="pb-8">
                        ...
                        >
                          ...
                          elit. Corporis, quaerat sunt ipsam repellendus
                          explicabo culpa eum odio molestiae unde, iste
                          doloremque maxime. Eligendi libero animi sapiente
                          quaerat inventore provident error.
                        </Typography>
                      </TimelineBody>
                    </TimelineItem>
                    <TimelineItem>
