    ...
    <nav>
      <div className="shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <ul className="flex">
          ...
          <li className="flex-1 mr-2">
            <a
              className="text-center block border border-blue-500 rounded py-2 px-4 bg-pearl-aqua hover:bg-blue-700 text-black"
              href="/"
            >
              Home
            </a>
          ...
          <li className="flex-1 mr-2">
            <a
              className="text-center block border border-white rounded hover:border-japanese-indigo-200 text-blue-500 hover:bg-japanese-indigo py-2 px-4 hover:text-white"
              href="/films"
            >
              Films
            </a>
