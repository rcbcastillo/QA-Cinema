    ...
    return (
        <div className='mx-4 my-6'>
            ...
            <table className='custom-table'>
                <thead>
                    <tr>
                        <th className='custom-table-cell'>Symbol</th>
                        <th className='custom-table-cell'>Rating</th>
                        <th className='custom-table-cell'>Description</th>
                        <th className='custom-table-cell'>Guidance</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td className='custom-table-cell'>Universal</td>
                        <td className='custom-table-cell'><p>Suitable for all. A U film should be suitable 
                            for audiences aged four years and over.</p>
                        </td>
                        <td className='custom-table-cell'><p>May contain infrequent very mild language. May contain very mild 
                    ...
                    <tr>
                        ...
                        <td className='custom-table-cell'>Parental Guidance</td>
                        <td className='custom-table-cell'><p>General viewing, but some scenes may be unsuitable
                             for young children. A PG film should not unsettle a child aged around eight or older.</p></td>

                        <td className='custom-table-cell'><p>May contain mild language (frequent/aggressive use may result in the work being passed
                    ...
                    <tr>
                        <td className='custom-table-cell'>
                            <img src={parental}
                            alt="Parental Guidance, PG letters symbol"></img></td>
                        <td className='custom-table-cell'>12A</td>
